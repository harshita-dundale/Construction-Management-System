...
//             //  amountPaid: 0, 
//             amountPaid: Math.max(0, totalPayable - actualPaidAmount),
...
//   const handleAmountChange = (workerId, value, remaining) => {
//     let paid = parseInt(value, 10) || 0;
...
//   };
//   if (loading)
//     return <div className="text-center my-4">Loading payroll...</div>;
...
//                         disabled={
//                           worker.amountPaid <= 0 ||
//                           worker.payable - (worker.actualPaid || 0) <= 0
//                         }
//                         style={buttonStyle}
//                       >
//                         Confirm
...
//                                 <td>
//                                   ₹
//                                   {record.paidAmount || record.totalAmount || 0}
//                                 </td>
//                                 <td>
//                                   ₹
//                                   {record.balance != null
