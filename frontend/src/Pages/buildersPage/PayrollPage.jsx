...
//   // 3️⃣ Confirm payment - VALIDATION ADD
...
//     // ✅ Payable amount se zyada nahi dena chahiye (already paid amount consider kar ke)
...
//       // ✅ Reset amount after successful payment and refresh status
//       setHiredWorkers((prev) =>
//         prev.map((w) => {
//           if (w._id === worker._id) {
...
//       <h2 className="mb-4 fw-bold">🧾 Payroll Summary</h2>
...
//                         (Paid: ₹{worker.actualPaid}, Remaining: ₹{remainingPayable})
//                       </small>
//                     )}
//                   </td>
...
//                       min="0"                    // ✅ Negative nahi allow
//                       max={Math.max(0, worker.payable - (worker.actualPaid || 0))}  // ✅ Already paid amount minus kar ke max limit
...
//                       disabled={worker.amountPaid <= 0 || (worker.payable - (worker.actualPaid || 0)) <= 0}  // ✅ Disable if fully paid
//                     >
//                       💾 Confirm
//                     </button>
//                   </td>
