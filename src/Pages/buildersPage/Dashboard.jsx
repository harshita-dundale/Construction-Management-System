...
//       <h1 className="mb-4" style={{marginTop:"7rem", alignItems:"center"}}>Worker Attendance and Payment</h1>
  ...
  return (
    <>
      ...
      <div className="container mt-5">
        <h1 className="mb-4 text-center" style={{ marginTop: "7rem" }}>Worker Attendance and Payment</h1>
